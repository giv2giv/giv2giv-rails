...
module CharityImport
  module Classification
    ...
    CLASSIFICATION = { '01' => { '1' => 'Government Instrumentality' },
                       ...
                       '09' => { '1' => 'Voluntary Employees\' Beneficiary Association (Non-Government Employees',
                                 '2' => 'Voluntary Employees\' Beneficiary Association (Government Employees)' },
                       '10' => { '1' => 'Domestic Fraternal Societies and Associations' },
                       '11' => { '1' => 'Teachers Retirement Fund Association' },
                       '12' => { '1' => 'Benevolent Life Insurance Association',
                                 '2' => 'Mutual Ditch or Irrigation Company',
                                 '3' => 'Mutual Cooperative Telephone Company',
                                 '4' => 'Organization Like Those on Three Preceding Lines' },
                       '13' => { '1' => 'Burial Association',
                                 '2' => 'Cemetery Company' },
                       '14' => { '1' => 'Credit Union',
                                 '2' => 'Other Mutual Corporation or Association' },
                       '15' => { '1' => 'Mutual Insurance Company or Association Other Than Life or Marine' },
                       '16' => { '1' => 'Corporate Financing Crop Operations' },
                       '17' => { '1' => 'Supplemental Unemployment Compensation Trust or Plan' },
                       '18' => { '1' => 'Employee Funded Pension Trust' },
                       ...
                       '23' => { '1' => 'Veterans Association' },
                       '24' => { '1' => 'Trust ERISA' },
                       '25' => { '1' => 'Title Holding Company for Pensions' },
                       ...
                       '40' => { '1' => 'Apostolic and Religious Orgization (501(d))' },
                       '50' => { '1' => 'Cooperative Hospital Service Organization (501(e))' },
                       '60' => { '1' => 'Cooperative Service Organization of Operating EducationalOrganization (501(f))' },
    ...
    SCHOOL_ACTIVITIES = ['030', '031', '032', '033', '034', '035', '036', '037', '038', '039', '040', '041', '042', '043', '044', '045', '046', '059']
    # Cultural, Historical of Other Educational Activities
    EDUCATIONAL_ACTIVITIES = ['060', '061', '062', '063', '064', '065', '088', '089', '090', '091', '092', '093', '094', '119']
    # Other Instructions and Training Activities
    TRAINING_ACTIVITIES = ['120', '121', '122', '123', '124', '125', '126', '149']
    # Health Services and Related Activities
    HEALTH_ACTIVITIES = ['150', '151', '152', '153', '154', '155', '156', '157', '158', '159', '160', '161', '162', '163', '164', '165', '166', '167', '168', '169', '179']
    # Scientific Research Activities
    SCIENTIFIC_ACTIVITIES = ['180', '181', '199']
    # Business and Professional Organizations
    BUSINESS_ACTIVITIES = ['200', '201', '202', '203', '204', '205', '206', '207', '208', '209', '210', '211', '212', '213', '229']
    # Farming and Related Activities
    FARMING_ACTIVITIES = ['230', '231', '232', '233', '234', '235', '236', '237', '249']
    # Mutual Organizations
    MUTUAL_ACTIVITIES = ['250', '251', '252', '253', '254', '259']
    # Employee of Membership Benefit Organizations
    EMPLOYEE_BENEFIT_ACTIVITIES = ['260', '261', '262', '263', '264', '265', '266', '267', '268', '269', '279']
    # Sports, Athletic Recreational and Social Activities
    SPORT_ACTIVITES = ['280', '281', '282', '283', '284', '285', '286', '287', '288', '296', '297', '298', '299', '300', '301', '317', '318', '319']
    # Youth Activities
    YOUTH_ACTIVITIES = ['320', '321', '322', '323', '324', '325','326', '327', '328', '349']
    # Conservation, Environmental and Beautification Activities
    ENVIRONMENTAL_ACTIVITIES = ['350', '351', '352', '353', '354', '355', '356', '379']
    # Housing Activities
    HOUSING_ACTIVITIES = ['380', '381', '382', '398', '399']
    # Inner City or Community Activities
    COMMUNITY_ACTIVITIES = ['400', '401', '402', '403', '404', '405', '406', '407', '408', '429']
    # Civil Rights Activities
    CIVIL_RIGHTS_ACTIVITIES = ['430', '431', '432', '449']
    # Litigation and Legal Aid Activities
    LITIGATION_ACTIVITIES = ['460', '461', '462', '463', '465']
    # Legislative and Political Activities
    POLITICAL_ACTIVITIES = ['480', '481', '482', '483', '484', '509']
    # Advocacy Attempt to influence public opinion concerning:
    PUBLIC_OPINION_ACTIVITIES = ['510', '511', '512', '513', '514', '515', '516', '517', '518', '519', '520', '521', '522', '523', '524', '525',
                                 '526', '527', '528', '529', '530', '531', '532','533','534','535','536','537','538','539','540','541','542','543','559']
    # Other Activities Directed to Individuals
    INDIVIDUAL_ACTIVITIES = ['560', '561', '562', '563', '564', '565', '566', '567', '568', '569', '572', '573', '574', '575']
    # Activities Purposes and Activities
    PURPOSE_ACTIVITIES = ['600', '601', '602', '603']
    # Other Purposes and Activities
    OTHER_ACTIVITIES = ['900', '901', '902', '903' ,'904', '905', '906', '907', '908', '909', '910', '911', '912', '913', '914', '915', '916', '917',
                        '918', '919', '920', '921', '922', '923', '924', '925', '926', '927', '928', '930', '931', '990', '994', '995', '998']
    ...
    NTEE_COMMON_CODES = { 'A' => 'Arts, Culture and Humanities',
    ...
    NTEE_CORE_CODES = { 'A01' => 'Alliance/Advocacy Organizations',
