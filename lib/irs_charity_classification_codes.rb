...
module IRS
  module CharityClassificationCodes

    # The National Taxonomy of Exempt Entities (NTEE) Code is a four digit code used to classify an exempt
    # organization in terms of its primary exempt activity.  A table of the codes found in the first three-digits
    # can be found described below. The first digit (Common Code) is a modifier used to describe activities in
    # support of nonprofit organizations.  The fourth digit further defines the classification of the organization
    # and is not defined here.

    # the first digit of ntee code
    NTEE_COMMON_CODES = {'A' => 'Arts, Culture and Humanities',
      ...
      NTEE_CORE_CODES = {#A Arts, Culture and Humanities
